    ...
    >
      ...
      <div className="w-96 bg-white bg-opacity-50 rounded-md p-8">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4">
            <p className="text-gray-700 text-center">Not a user?</p>
            <Link to="/signup">
              <button className=" ml-28 bg-gray-200 hover:bg-gray-300 text-gray-700 text-sm font-bold py-2 px-4 mt-4  rounded focus:outline-none focus:shadow-outline">
                Sign Up
              </button>
            </Link>
          </div>
